export const metadata = {
  title: 'Data Sources',
  description: 'A directory of open access and protected access genomics data sources, from the 1000 Genomes Project to St. Jude Cloud and beyond.',
}

export const sections = [
  { title: 'Open Access Data', id: 'open-access-data' },
  { title: 'Protected Access Data', id: 'protected-access-data' },
]
