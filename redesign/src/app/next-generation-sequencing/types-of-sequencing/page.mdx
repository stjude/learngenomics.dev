...
export const sections = [
  { title: 'Common Sequence Applications', id: 'common-sequence-applications' },
  { title: 'Whole Genome Sequencing', id: 'whole-genome-sequencing' },
  { title: 'Whole Exome Sequencing', id: 'whole-exome-sequencing' },
  { title: 'Whole Transcriptome Sequencing or RNA-seq', id: 'whole-transcriptome-sequencing-or-rna-seq' },
  { title: 'Targeted Sequencing', id: 'targeted-sequencing' },
]

# Types of Sequencing

Sequencing is a laboratory technique that identifies and determines the order of bases in a DNA molecule. Each sequencing type is best analyzed by a different computational method and is interpreted in a different way. The scientific goals of the research, cost and practical limits determine which types of sequencing are chosen. For example, clinical sequencing seeks the time-sensitive detection of known mutations, while population studies focus on the discovery of new variants. Often, the type of sequencing ordered is a trade-off between cost and the breadth of information. This section discusses what scientists weigh when deciding which pieces of the genome/exome/transcriptome needs sequencing.
