export const metadata = {
  ...
  description: 'A primer on cancer genomics - understanding driver mutations, oncogenes, tumor suppressors, and the evolutionary basis of cancer.',
}

export const sections = [
  { title: 'Tumor vs. Germline Mutations', id: 'tumor-vs-germline-mutations' },
  { title: 'Hallmarks of Cancer', id: 'hallmarks-of-cancer' },
  { title: 'Oncogenes and Tumor Suppressors', id: 'oncogenes-and-tumor-suppressors' },
  { title: 'The Evolutionary Basis for Controlled Growth', id: 'the-evolutionary-basis-for-controlled-growth' },
  { title: 'Control Signals and the Immune System', id: 'control-signals-and-the-immune-system' },
  { title: 'Gain and Loss of Function', id: 'gain-and-loss-of-function' },
  { title: 'Genomic Instability', id: 'genomic-instability' },
  { title: 'Gene Pathways', id: 'gene-pathways' },
  { title: 'The RAS Pathway', id: 'the-ras-pathway' },
]
