...
export const sections = [
  { title: 'Genomic Regions and Transcription', id: 'genomic-regions-and-transcription' },
  { title: 'Bakery Analogy', id: 'bakery-analogy' },
]
...
[the relevant advanced topics guide](/advanced-topics/alternative-splicing)).
...
detail within the [Genomic Variation](/genomic-variation/index) section of this
guide.
